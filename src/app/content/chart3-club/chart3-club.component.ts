...
@Component({
  selector: 'app-chart3-club',
  templateUrl: './chart3-club.component.html',
  styleUrls: ['./chart3-club.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class Chart3ClubComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.getDataService.getClubJSON_Data('chart3_club')
      .subscribe(
      data => {
        this.data = data;
