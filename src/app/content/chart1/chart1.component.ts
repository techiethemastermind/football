...
export class Chart1Component implements OnInit {
    ...
    ngOnInit() {
        ...
        this.getDataService.getJSON('team')
            ...
            data_team => {
                ...
                this.getDataService.getJSON_Param('chart1', 'bar', this.selected_team)
                    .subscribe(
                    data => {
                        this.data = data;
    ...
    initialBarChart() {
        ...
        let pk = this.teams[this.selected_team - 1].key;
        this.players = this.playersData[pk];
        let len = data.length;
        for (let i = 0; i < len; i++) {
            data[i].name = this.players[i].name;
        }
