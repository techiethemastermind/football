...
@Component({
  selector: 'app-chart6-club',
  templateUrl: './chart6-club.component.html',
  styleUrls: ['./chart6-club.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class Chart6ClubComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.getDataService.getClubJSON_Data('chart6_club')
      .subscribe(
      data => {
        this.data = data;
        if (this.displayType) {
